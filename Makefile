...
# 默认目标：显示帮助信息
help:
	@echo "$(GREEN)ServiceAgent Makefile$(NC)"
	@echo ""
	@echo "可用命令："
	...
	@echo "  $(YELLOW)make upload$(NC)  - 上传 bike-service-docs 目录下的所有文档"
...
init:
	@echo "$(GREEN)🚀 开始一键初始化 ServiceAgent...$(NC)"
	@echo ""
	...
	@$(MAKE) wait
	@echo ""
	@echo "$(YELLOW)步骤 4/4: 上传单车客服知识库文档到向量数据库$(NC)"
	@$(MAKE) upload
	@echo ""
	@echo "$(GREEN)═══════════════════════════════════════════════════════$(NC)"
